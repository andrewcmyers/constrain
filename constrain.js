...
// Adapted from numeric-1.2.6.js to allow f to supply the gradient directly.
//
// Returns: a local minimum of a function f(x) whose gradient is g(x).
...
class Abs extends UnaryExpression {
    ...
    backprop(task) {
        const a = evaluate(this, valuation),
              d = this.bpDiff
...
class Sqrt extends UnaryExpression {
    ...
    backprop(task) {
        const a = evaluate(this.expr, valuation),
              d = this.bpDiff
        if (a == 0) return 0
